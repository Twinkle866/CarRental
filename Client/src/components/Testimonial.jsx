...
const Testimonial = () => {
  const testimonials = [
    ...
    },
    {
      ...
      image: assets.testimonial_image_1, // <- agar available hai
  ...
  return (
    <div className="py-28 px-6 md:px-16 lg:px-24 xl:px-44">
      <Title
        ...
        subTitle="Discover why discerning travellers choose StayVentures for their luxury accommodations around the world."
      />
