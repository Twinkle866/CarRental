...
const Hero = () => {
       ...
       const handleSearch = (e) => {
              e.preventDefault()
              navigate('/car?pickupLocation=' + pickupLocation + '&pickupDate=' +
       ...
       return (
              ...
              className='h-screen flex flex-col items-center justify-center gap-14 bg-light text-center'>
               ...
               transition={{duration:0.8,delay:0.2}}
                     ...
                     animate={{y:0,opacity:1}}
                     transition={{duration:0.8, delay:0.2}}
                     onSubmit={handleSearch} className='flex flex-col md:flex-row items-start md:items-center justify-between p-6 rounded-lg md:rounded-full w-full max-w-80 md:max-w-200 bg-white shadow-[0px_8px_20px_rgba(0,0,0,0.1)] gap-6'>
                            {/* Pickup Location */}
